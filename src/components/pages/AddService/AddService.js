...
const AddService = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        fetch('https://assignment-11-server-bay.vercel.app/addservice', {
            method: 'POST',
            headers: {
