        ...
        <>
            <section className="my-8 dark:bg-gray-800 dark:text-gray-100">
                ...
                <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                    {
                        customerReviews.map(review => <div key={review._id} className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                            ...
                            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-400 dark:text-gray-900">
                                <img src={user?.photoURL} alt="" className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full dark:bg-gray-500 dark:bg-gray-700" />
            ...
            {
                (user && user.uid) ?
                    <SubmitReview service={service} user={user}></SubmitReview>
                    :
                    <>
